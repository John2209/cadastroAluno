...
import alunos.*;
/**
 * Coordena as operações do cadastro de alunos.
 * Mantém as operações principais da aplicação.
 *
...
public class CadastroAlunos {
    ...
    public boolean inserirAluno(int qtde) {
        ...
        while (idade < 1 || idade > 120) {
            ...
            if (idade < 1 || idade > 120) {
                this.menu.exibirMensagem("Informe um numero inteiro valido entre 1 e 120\n");
            }
        }
        ...
        while (semestre < 1) {
            ...
            if (semestre < 1) {
                this.menu.exibirMensagem("Informe um numero inteiro valido\n");
            }
        }
    ...
    public boolean atualizarAluno(int qtde) {
        ...
        while (semestre < 1) {
            ...
            if (semestre < 1) {
                this.menu.exibirMensagem("Informe um numero valido\n");
            }
        }
